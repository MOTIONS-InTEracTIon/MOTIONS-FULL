...
namespace Memoria{
	...
	public class ButtonPanelTIIES : ButtonPanel {
		...
		public PopUpController escapePopUp;
		...
		public void selectButton1(){
			Debug.Log ("Entre al selectButton1");
		...
		public void cancelExit(){
			...
			InterfaceManager.Instance.leapMotionManager.leapMotionRig.transform.position = new Vector3 (InterfaceManager.Instance.leapMotionManager.leapMotionRig.transform.position.x, InterfaceManager.Instance.leapMotionManager.leapMotionRig.transform.position.y, 0f);
		}
