...
namespace Memoria
{
	...
	public class LoadImages : LoadImageBehaviour
	{
		...
		public override void Initialize(LoadImagesController loadImagesController)
		{
			...
			if (!GLPlayerPrefs.GetBool(ProfileManager.Instance.currentEvaluationScope, "BGIIESMode") && !GLPlayerPrefs.GetBool(ProfileManager.Instance.currentEvaluationScope, "TIIESMode"))
            {
				Debug.Log ("Entre al modo de vortices para el initialize del loadImagesController");
            ...
            {
				Debug.Log ("Entre al modo BGIIESMode para el initialize del loadImagesController");
