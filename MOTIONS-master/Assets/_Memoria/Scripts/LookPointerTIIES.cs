...

{
	...
	public class LookPointerTIIES : LookPointer, IAwake, IUpdate {
		...
		public void SelectCat1(){
			...
			if (VisualizationManager.Instance.tiiesVisualization.buttonTiies.panelCat1 < VisualizationManager.Instance.tiiesVisualization.buttonTiies.auxCat1) {
				VisualizationManager.Instance.tiiesVisualization.buttonTiies.rangeDioCat1 = VisualizationManager.Instance.tiiesVisualization.buttonTiies.rangeDioCat1 - 12;
				VisualizationManager.Instance.tiiesVisualization.buttonTiies.auxCat1--;
		...
		public void SelectCat2(){
			...
			if (VisualizationManager.Instance.tiiesVisualization.buttonTiies.panelCat2 < VisualizationManager.Instance.tiiesVisualization.buttonTiies.auxCat2) {
				VisualizationManager.Instance.tiiesVisualization.buttonTiies.rangeDioCat2 = VisualizationManager.Instance.tiiesVisualization.buttonTiies.rangeDioCat2 - 12;
				VisualizationManager.Instance.tiiesVisualization.buttonTiies.auxCat2--;
		...
		public void SelectCat3(){
			...
			if (VisualizationManager.Instance.tiiesVisualization.buttonTiies.panelCat3 < VisualizationManager.Instance.tiiesVisualization.buttonTiies.auxCat3) {
				VisualizationManager.Instance.tiiesVisualization.buttonTiies.rangeDioCat3 = VisualizationManager.Instance.tiiesVisualization.buttonTiies.rangeDioCat3 - 12;
				VisualizationManager.Instance.tiiesVisualization.buttonTiies.auxCat3--;
		...
		public void SelectCat4(){
			...
			if (VisualizationManager.Instance.tiiesVisualization.buttonTiies.panelCat4 < VisualizationManager.Instance.tiiesVisualization.buttonTiies.auxCat4) {
				VisualizationManager.Instance.tiiesVisualization.buttonTiies.rangeDioCat4 = VisualizationManager.Instance.tiiesVisualization.buttonTiies.rangeDioCat4 - 12;
				VisualizationManager.Instance.tiiesVisualization.buttonTiies.auxCat4--;
		...
		public void DIOClassifier(List<PitchGrabObject> list, bool cat1, bool cat2, bool cat3, bool cat4, int paneles){
			...
			for (int i = 0; i < list.Count; i++) {
				...
				if (index == 1) {
					list [i].transform.position = new Vector3 (InterfaceManager.Instance.leapMotionManager.leapMotionRig.transform.position.x + 0.021f, InterfaceManager.Instance.leapMotionManager.leapMotionRig.transform.position.y + 0.032f, InterfaceManager.Instance.leapMotionManager.transform.position.z + 0.05f);
					//list [i].transform.position = new Vector3 (0.021f, 3.692f, 0.05f);
				}

				if (index > 1 && index < 5) {
					list [i].transform.position = new Vector3 (list [i - 1].transform.position.x + 0.035f, list[i - 1].transform.position.y, list[i - 1].transform.position.z);

				}
				if (index == 5) {
					list [i].transform.position = new Vector3 (InterfaceManager.Instance.leapMotionManager.leapMotionRig.transform.position.x + 0.021f, list [i - 1].transform.position.y - 0.035f, list[i - 1].transform.position.z);
